...
class BaseGradientEstimator(ABC):
    ...
    def update(self, x: np.ndarray, y: float, lightweight: bool = False):
        """
        ...
        Args:
            lightweight: If True, only sync history without expensive recomputation.
                         Used by the line search to avoid redundant LP solves.
        """
        pass
